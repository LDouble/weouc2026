...
- **Description**: 
  ...
  - 状态值：draft, reviewing, published, rejected, offline, cancelled, full
...
## [ ] Task 3: 修改 meetup 模块状态处理
- **Priority**: P0
- **Depends On**: Task 2
- **Description**: 
  - 修改 buildMeetupPayload 函数，返回统一的 status 字段
  - 更新 normalizeMeetupStatus 和 normalizeReviewStatus 函数
  - 修改 refreshMeetupStatus 函数
...
## [ ] Task 4: 修改其他模块状态处理（market/errand/resource/lostFound/carpool）
- **Priority**: P1
- **Depends On**: Task 2
- **Description**: 
