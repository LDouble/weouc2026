...
func RegisterRoutes(engine *gin.Engine, handler *Handler) {
	...
	protected.POST("/market/delete/:id", handler.DeleteMarket)
	...
	protected.POST("/resource/delete/:id", handler.DeleteResource)
	protected.POST("/lostFound/publish", handler.PublishLostFound)
	protected.POST("/lostFound/delete/:id", handler.DeleteLostFound)
	protected.POST("/lostFound/resolve/:id", handler.MarkLostFoundResolved)
	protected.POST("/carpool/publish", handler.PublishCarpool)
	protected.POST("/carpool/delete/:id", handler.DeleteCarpool)
