...
**ID:** api-server-v1-business-logic-completion
**Label:** API Server: V1 后端业务逻辑补齐
**Description:** 按 V1 产品范围补齐 `api-server` 剩余业务逻辑，覆盖校园生活持久化与组局、门户内容、消息中心、文件中心、统计审计与管理端审核能力
**Type:** Feature
**Status:** In Progress
**Priority:** High
**Created:** 2026-05-10
